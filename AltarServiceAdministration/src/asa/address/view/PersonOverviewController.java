...
/**
 * Part of the main over view, showing the details of a selected person.
 * 
...
public class PersonOverviewController {
	...
	private void showPersonDetails(Person person) {
		if (person != null) {
			...
			telNrLabel.setText(Integer.toString(person.getTelNumber()));
			groupLabel.setText(person.getGroup());
			email1Label.setText(person.getEmail1());
			email2Label.setText(person.getEmail2());
		} else {
